...
public class InsulinTherapy {
	...
	public final String TAG = "MealIOBControl";
	...
	public InsulinTherapy(
		...
		if (insulin_therapy(Tvec_cgm1, Tvec_spent, Tvec_IOB, Tvec_Gest, control_param, time, cycle_duration_mins, corrFlagTime, hypoFlagTime, calFlagTime, mealFlagTime, brakes_coeff))
			valid = true;
		else
			valid = false;
	}
	...
	public boolean insulin_therapy(
		...
		therapy_data.differential_basal_rate = differentialBasalRate(time, subject.basal, subject.CF, Tvec_Gest, Tvec_IOB);
