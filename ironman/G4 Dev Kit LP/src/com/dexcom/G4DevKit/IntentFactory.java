...
/*    */ 
/* 35 */     if (className.equals("com.dexcom.G4DevKit.EstimatedGlucoseRecord"))
/*    */     {
/* 37 */       dataTypeParam = "EGV";
/*    */     }
/* 39 */     else if (className.equals("com.dexcom.G4DevKit.MeterRecord"))
/*    */     {
/* 41 */       dataTypeParam = "METER";
/*    */     }
/* 43 */     else if (className.equals("com.dexcom.G4DevKit.SettingsRecord"))
/*    */     {
/* 45 */       dataTypeParam = "SETTINGS";
/*    */     }
/* 47 */     else if (className.equals("com.dexcom.G4DevKit.InsertionTimeRecord"))
/*    */     {
