...
public class IOMain extends Service {
    ...
    // DiAsService Messenger 
    public Messenger mMessengerToClient = null;
    // BRMservice Messenger
    ...
    // Handle commands from DiAsService
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
				...
				case APC_SERVICE_CMD_START_SERVICE:		// start service command
					...
					// Inform DiAsService how many ticks you require per control tick
