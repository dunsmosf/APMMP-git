...
public class CgmService extends Service {	
    ...
    public void onCreate() {
        ...
        Debug.log(this, TAG, "onCreate", Debug.LOG_DEBUG);
    ...
    public void onDestroy() {
        ...
        Toast.makeText(this, "CGM Service Stopped", Toast.LENGTH_SHORT).show();
    	...
    	public void handleMessage(Message msg)
    	{
    		...
    		switch(msg.what)
    		{
	    		...
	    		case DRIVER2CGM_SERVICE_CALIBRATE_ACK:
    				...
    				Debug.log(main, TAG, "Calibration: "+activeCgm.cal_value+" Time: "+cal_time);
    ...
    private void sendCGMData(Cgm cgm)
    {
    	...
    	{    		
			...
			values.put("recv_time", getCurrentTimeSeconds());
		 	...
		 	// Log the CGM time and value
			Debug.log(this, TAG, "CGM: "+cgm.value+" Time: "+cgm.time);
