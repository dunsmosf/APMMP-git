...
public class Biometrics {
    ...
    SYSTEM_URI,	INSULIN_CREDIT_URI,	CONSTRAINTS_URI,	GPS_URI,	EXERCISE_SENSOR_URI,
    ACC_URI,	EXERCISE_STATE_URI, SERVICE_OUTPUTS_URI
	};
	
	// List of the (6) single-row tables URIs
	public static final Uri[] SINGLE_ROW_TABLES_URIS = {
    HARDWARE_CONFIGURATION_URI,	PASSWORD_URI,	CGM_DETAILS_URI,	PUMP_DETAILS_URI,	SERVER_URI, TEMP_BASAL_URI
	};
