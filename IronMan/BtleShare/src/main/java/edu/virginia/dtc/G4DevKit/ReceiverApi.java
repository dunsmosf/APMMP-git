...
/*     */ class ReceiverApi
/*     */ {
/*     */   private final IReceiverComm m_receiverComm;
/*  10 */   private final PacketTools m_ptools = new PacketTools();

			private int rxTotal = 0;

/*     */   ReceiverApi(IReceiverComm commInterface)
/*     */   {
/*  15 */     this.m_receiverComm = commInterface;
/*     */   }
/*     */ 
...
/*     */     try
/*     */     {
/*  32 */       byte[] reply = this.m_receiverComm.sendReceiverMessageForResponse(truncatedMessage);
/*     */ 
...
/*     */ 
/*  99 */     byte[] reply = this.m_receiverComm
